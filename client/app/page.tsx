    ...
    return (
        <main>
            ...
            <section className="py-20">
                <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-10">
                    ...
                    <div className="flex-1">
                        ...
                        <Link
                            href="/products"
                            className="mt-6 inline-block px-6 py-3 rounded-lg bg-(--accent) text-white text-lg font-semibold hover:opacity-90 transition"
                        >
                            Explore Marketplace
                        </Link>
                    </div>
            ...
            <section className="py-16 bg-(--card)">
                <h3 className="text-3xl font-serif font-bold text-center">Shop by Category</h3>

                <div className="flex flex-wrap justify-center gap-4 mt-8 px-4">
                    {["Ceramics", "Woodwork", "Textiles", "Jewelry", "Home Decor"].map((cat) => (
                        <span
                            key={cat}
                            className="px-6 py-2 bg-(--border) rounded-full text-(--foreground) hover:shadow-md transition cursor-pointer"
                        >
                            {cat}
                        </span>
                    ))}
            ...
            <section className="py-16">
                <h3 className="text-3xl font-serif font-bold text-center">Meet the Artisans</h3>

                <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10 mt-12 px-6">
                    {[1, 2, 3].map((i) => (
                        <div
                            key={i}
                            className="bg-(--card) border border-(--border) p-6 rounded-xl shadow-sm hover:shadow-md transform hover:-translate-y-1 transition"
                        >
                            <img
                            ...
                            <p className="text-(--foreground)/70">Specialty Craft</p>
                            <button className="mt-4 px-4 py-2 bg-(--accent) text-white rounded-lg hover:opacity-90">
                                View Profile
                            </button>
                        </div>
                    ))}
                    ...
                    {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                        ...
                        >
                            ...
                            <div className="p-4">
                                ...
                                <p className="text-(--accent) font-semibold mt-1">$24.99</p>
